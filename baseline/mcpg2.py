...
from simulator2 import SimulatorGraphMaxCut, load_graph
...
net.parameter_theta, prob = net(input=net.parameter_theta)
for _ in range():

    x = sampler_function(prob)
    objective = reward_func(...)
