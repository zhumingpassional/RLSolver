...
def load_graph_from_txt(txt_path: str = 'G14.txt') -> GraphList:
    ...
    assert num_nodes == obtain_num_nodes(graph_list=graph)
...
def check_get_hot_tenor_of_graph():
    ...
    graph_names = []
    for graph_type in ['erdos_renyi', 'powerlaw', 'barabasi_albert']:
    ...
    for graph_name in graph_names:
        graph_list: GraphList = load_graph(graph_name=graph_name)
